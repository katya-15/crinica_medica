...
<body class="min-h-screen flex flex-col">
    ...
    <header class="backdrop-blur-md border-b border-neutral shadow-lg relative z-50">
    ...
    <main class="flex-grow container mx-auto px-4 py-6">
        ...
        <div class="container mx-auto px-6 max-w-5xl py-8">
            <div class="hero">
                <div class="hero-content flex-col lg:flex-row-reverse gap-8">
                    ...
                    <div>
                        <h1 class="text-5xl text-warning font-bold">Misión</h1>
            ...
            <div class="hero">
                <div class="hero-content flex-col lg:flex-row gap-8">
                    <img src="{{ asset('img/consultorio.jpeg') }}"
                        class="rounded-2xl shadow-xl object-cover w-full h-72 sm:h-80 lg:h-96" />
                    <div>
                        <h1 class="text-5xl text-warning font-bold">Visión</h1>
                        <p class="py-4 text-black">
        ...
        <div class="container mx-auto px-6 max-w-5xl py-6">
            <div class="hero  ">
                <div class="hero-content text-center">
                    <div class="max-w-md">
                        <h1 class="text-5xl text-warning font-bold mb-4">Objetivos</h1>

                        <ul class="text-black text-left list-disc list-inside space-y-2">
                            <li>
        ...
        <div class="container mx-auto py-8">
            <h1 class="text-3xl text-warning font-bold">Contamos con novedades</h1>
            <div class="flex justify-center py-8">
                ...
                <div class="flex flex-row flex-wrap justify-center gap-6">
                    <div class="card bg-base-100 w-80 shadow-md hover:shadow-xl transition-shadow">
                        ...
                        <div class="card-body">
                            <h2 class="card-title text-success">Equipos médicos de última generación</h2>
                            <p class="text-black">Contamos con la mejor y más nueva tecnología médica para cuidarte.
                    ...
                    <div class="card bg-base-100 w-80 shadow-md hover:shadow-xl transition-shadow">
                        ...
                        <div class="card-body">
                            <h2 class="card-title text-success">Fisioterapia</h2>
                            <p class="text-black">Nuestros tratamientos de fisioterapia le ayudan a dejar atrás el
                    ...
                    <div class="card bg-base-100 w-80 shadow-md hover:shadow-xl transition-shadow">
                        ...
                        <div class="card-body">
                            <h2 class="card-title text-success">Tomógrafo Computarizado </h2>
                            <p class="text-black">Hemos adquirido un Tomógrafo Computarizado de última generación, una
        ...
        <div class="container mx-auto px-6 max-w-5xl py-6">
            <div class="hero  ">
                <div class="hero-content text-center">
                    <div class="max-w-md">
                        <h1 class="text-5xl text-warning font-bold mb-4">Catalogo de servicios</h1>
